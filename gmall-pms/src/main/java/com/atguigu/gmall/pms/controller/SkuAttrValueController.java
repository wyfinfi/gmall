...
public class SkuAttrValueController {
    ...
    public ResponseVo<String> querySkusJsonBySpuId(@PathVariable("spuId") Long spuId){
        String skuJson=this.skuAttrValueService.querySkusJsonBySpuId(spuId);
        return ResponseVo.ok(skuJson);
    }
    @GetMapping("skusale/{skuId}")
    ...
    public ResponseVo<List<SaleAttrValueVo>> querySkuAttrValuesBySpuId(@PathVariable("spuId")Long spuId){
        List<SaleAttrValueVo> saleAttrValueVos=
    ...
    public ResponseVo<List<SkuAttrValueEntity>>
        querySearchAttrValueBySkuId(@PathVariable("skuId") Long skuId){
        List<SkuAttrValueEntity> attrValueEntities =
                skuAttrValueService.querySearchAttrValueBySkuId(skuId);
