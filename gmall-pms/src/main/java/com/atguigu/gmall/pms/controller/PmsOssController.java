...
public class PmsOssController {
    ...
    String accessId = "LTAI4GE3QBZWYFtQ3RyGzsxX"; // 请填写您的AccessKeyId。
    String accessKey = "3zG0vo49jOnMG0jhopoOnZqqQWE08Y"; // 请填写您的AccessKeySecret。
    String endpoint = "oss-cn-shanghai.aliyuncs.com"; // 请填写您的 endpoint。
    String bucket = "guli-ec-file"; // 请填写您的 bucketname 。
